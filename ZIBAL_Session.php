...
if ( !class_exists( 'ZIBAL_Session' ) ) {
    ...
    function ZIBAL_Session_cleanup() {
        ...
        if ( ! defined( 'ZIBAL_INSTALLING' ) ) {
            ...
            foreach( $expiration_keys as $expiration ) {
                if ( $now > intval( $expiration->option_value ) ) {
                    ...
                    $expired_sessions[] = "_ZIBAL_Session_$session_id";
                }
            }
        ...
        do_action( 'ZIBAL_Session_cleanup' );
    }
    add_action( 'ZIBAL_Session_garbage_collection', 'ZIBAL_Session_cleanup' );
    function ZIBAL_Session_register_garbage_collection() {
        if ( !wp_next_scheduled( 'ZIBAL_Session_garbage_collection' ) ) {
            wp_schedule_event( time(), 'hourly', 'ZIBAL_Session_garbage_collection' );
        }
    }
    add_action( 'wp', 'ZIBAL_Session_register_garbage_collection' );
}
?>